...
public final class User implements Model {
  ...
  public static final QueryField INFO = field("User", "info");
  ...
  private User(String id, String name, String info) {
    this.id = id;
    this.name = name;
    this.info = info;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getInfo(), user.getInfo()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String info) {
      super.id(id);
      super.name(name)
        .info(info);
    }
